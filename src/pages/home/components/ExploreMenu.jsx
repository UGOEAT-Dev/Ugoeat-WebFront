...
export default function ExploreMenu()
{
    return (
        <div className="p-5 text-center">
            ...
            <NavLink to="/order" className="inline-block cursor-pointer bg-green hover:bg-green-700 text-base text-white p-3 rounded-md md:text-2xl">Explorez le menu</NavLink>
        </div>
    )
}