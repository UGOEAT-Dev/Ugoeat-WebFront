 ...
 */
function UserDialogView({user, onHide, visible, ...props})
{
    const userCredentials = [
        { name: "Id", value: user.id },
        { name: "Role", value: parseUserRole(user.role) },
        { name: "Telephone", value: user.tel ?? 'NULL' },
        { name: "Adresse", value: user.address ?? 'NULL' },
        { name: "Inscrit le", value: new Date(user.created_at).toLocaleDateString() }
    ]
