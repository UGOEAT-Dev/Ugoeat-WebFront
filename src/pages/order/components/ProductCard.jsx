...
{
    return (
        <div onClick={() => onClick(product)} className={"card flex flex-col space-y-3 pb-5 w-[250px] lg:w-[300px] max-w-[300px] p-2 rounded-xl shadow-lg border " + className}>
            <div className="flex justify-center overflow-hidden w-full rounded-t-xl h-[200px]">
